...
def construct_mini_batch_giant_graph(all_graphs, max_num_edges):
    ...
    all_rows, all_cols, all_eids, all_nodes, all_dts ,all_ws = [],[], [], [], [], []
    ...
    for all_graph in all_graphs:
        ...
        all_ws.append(all_graph['weights'][:num_edges])
    ...
    all_ws = np.concatenate(all_ws).astype(np.float32)
